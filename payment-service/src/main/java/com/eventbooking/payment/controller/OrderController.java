...
public class OrderController {
    ...
    @GetMapping("/{orderId}")
    public ResponseEntity<ApiResponse<OrderDto>> getOrderById(@PathVariable("orderId") UUID orderId) {
    ...
    public ResponseEntity<ApiResponse<com.eventbooking.payment.dto.RefundResponse>> cancelOrderWithRefund(
        ...
        ApiResponse<com.eventbooking.payment.dto.RefundResponse> response = ApiResponse
                .success("Order cancelled and refund processed successfully", refund);
    ...
    public ResponseEntity<ApiResponse<com.eventbooking.payment.dto.RefundResponse>> partialCancelOrder(
        ...
        ApiResponse<com.eventbooking.payment.dto.RefundResponse> response = ApiResponse
                .success("Partial cancellation and refund processed successfully", refund);
